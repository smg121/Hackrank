        ...
        <table class="table">
                ...
                <tbody>
                    <tr>
                        <td>
                        <!--for Login form -->
            <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/home/login" method="POST">
    ...
    <div class="col-md-6">      
                ...
                <tr>
                    <td>
                            ...
                            <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>index.php/home/register" method="POST">
                                <div class="form-group">
